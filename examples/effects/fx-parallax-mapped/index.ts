...
import { buildCube, Device, LightType, ModelBuilder } from '@gglib/graphics'
...
const model = ModelBuilder.begin().tap((b) => {
  buildCube(b, { size: 2, tesselation: 32 })
})
  .endModel(device, {
    materials: [{
      ...
      parameters: {
        ...
        ParallaxMap: device.createTexture({ data: '/assets/textures/prototype/proto_alpha_h.png' }),
