...
TweakUi.mount('#tweak-ui', (ui) => {
  ui.slider(channel.settings, 'minHorizontalVelocity', { min: 0, max: 1, step: 0.01 })
  ui.slider(channel.settings, 'maxHorizontalVelocity', { min: 0, max: 1, step: 0.01 })
  ui.slider(channel.settings, 'minVerticalVelocity', { min: 0, max: 1, step: 0.01 })
  ui.slider(channel.settings, 'maxVerticalVelocity', { min: 0, max: 1, step: 0.01 })
  ui.slider(channel.settings, 'endVelocity', { min: 0, max: 1, step: 0.01 })
  ui.slider(channel.settings, 'minRotateSpeed', { min: -0.2, max: 0.2, step: 0.0001 })
  ui.slider(channel.settings, 'maxRotateSpeed', { min: -0.2, max: 0.2, step: 0.0001 })
  ui.slider(channel.settings, 'minStartSize', { min: 0.25, max: 100, step: 0.25 })
  ui.slider(channel.settings, 'maxStartSize', { min: 0.25, max: 100, step: 0.25 })
  ui.slider(channel.settings, 'minEndSize', { min: 0.25, max: 100, step: 0.25 })
