...
export type UpdateType = Brand<number, 'UpdateType'>
export const UpdateType = {
  None: brand<UpdateType>(0),
  Updated: brand<UpdateType>(1),
  Animated: brand<UpdateType>(2),
}
...
//         const dz =
//           (mod.TexMod_WRotateAmplitude || 0) * Math.sin(2 * Math.PI * (sz - Math.floor(sz))) +
//           (mod.TexMod_WRotatePhase || 0)
