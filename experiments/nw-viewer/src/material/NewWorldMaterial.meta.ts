...
export default {
  ...
  UvTransform2: inputSlot('material', 'uvtransform2', 'mat4x4'),
  ...
  UvTransform1Enabled: inputSlot('material', 'uvtransform1enabled', 'scalar'),
  UvTransform2Enabled: inputSlot('material', 'uvtransform2enabled', 'scalar'),
