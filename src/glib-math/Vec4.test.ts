describe("Glib.Vec4", () => {
  ...
  function expectComponents(v, x, y, z, w) {
  ...
  describe("#constructor", () => {
    it ("initializes all components", function() {
      let v = new Glib.Vec4(1, 2, 3, 4)
      expectComponents(v, 1, 2, 3, 4)
    })

    it ("is valid without parameters", function() {
      let v = new Glib.Vec4()
  ...
  describe("#length", () => {
    it ("calculates length", () => {
      expect(new Glib.Vec4(2, 0, 0, 0).length()).toBe(2)
      expect(new Glib.Vec4(0, 3, 0, 0).length()).toBe(3)
      expect(new Glib.Vec4(0, 0, 4, 0).length()).toBe(4)
      expect(new Glib.Vec4(0, 0, 0, 5).length()).toBe(5)
    })
  })
  describe("#lengthSquared", () => {
    it ("calculates length", () => {
      expect(new Glib.Vec4(2, 0, 0, 0).lengthSquared()).toBe(4)
      expect(new Glib.Vec4(0, 3, 0, 0).lengthSquared()).toBe(9)
      expect(new Glib.Vec4(0, 0, 4, 0).lengthSquared()).toBe(16)
      expect(new Glib.Vec4(0, 0, 0, 5).lengthSquared()).toBe(25)
    })
  })
  describe("#distance", () => {
    it ("calculates distance", () => {
      expect(new Glib.Vec4(2, 0, 0, 0).distance(new Glib.Vec4(4, 0, 0, 0))).toBe(2)
      expect(new Glib.Vec4(0, 3, 0, 0).distance(new Glib.Vec4(0, 6, 0, 0))).toBe(3)
      expect(new Glib.Vec4(0, 0, 4, 0).distance(new Glib.Vec4(0, 0, 8, 0))).toBe(4)
      expect(new Glib.Vec4(0, 0, 0, 5).distance(new Glib.Vec4(0, 0, 0,10))).toBe(5)
    })
  })
  describe("#distanceSquared", () => {
    it ("calculates distance", () => {
      expect(new Glib.Vec4(2, 0, 0, 0).distanceSquared(new Glib.Vec4(4, 0, 0, 0))).toBe(4)
      expect(new Glib.Vec4(0, 3, 0, 0).distanceSquared(new Glib.Vec4(0, 6, 0, 0))).toBe(9)
      expect(new Glib.Vec4(0, 0, 4, 0).distanceSquared(new Glib.Vec4(0, 0, 8, 0))).toBe(16)
      expect(new Glib.Vec4(0, 0, 0, 5).distanceSquared(new Glib.Vec4(0, 0, 0,10))).toBe(25)
    })
  })
  describe("#dot", () => {
    it ("calculates dot", () => {
      expect(new Glib.Vec4(2, 0, 0, 0).dot(new Glib.Vec4(4, 0, 0, 0))).toBe(8)
      expect(new Glib.Vec4(0, 3, 0, 0).dot(new Glib.Vec4(0, 6, 0, 0))).toBe(18)
      expect(new Glib.Vec4(0, 0, 4, 0).dot(new Glib.Vec4(0, 0, 8, 0))).toBe(32)
      expect(new Glib.Vec4(0, 0, 0, 5).dot(new Glib.Vec4(0, 0, 0,10))).toBe(50)
    })
  })
  describe("#normalize", () => {
    it ("normalizes", () => expect(new Glib.Vec4(1, 2, 3, 4).normalize().length()).toBeCloseTo(1) )
  })
  describe("#normalizeOut", () => {
    it ("normalizes", () => expect(new Glib.Vec4(1, 2, 3, 4).normalizeOut(a).length()).toBeCloseTo(1) )
    it ("returns out parameter", () => expect(new Glib.Vec4(1, 2, 3, 4).normalizeOut(a)).toBe(a) )
  })
  describe("#invert", () => {
    it ("inverts", () => expectComponents(new Glib.Vec4(2, 4, 8, 16).invert(), 0.5, 0.25, 0.125, 0.0625) )
    it ("return instance", () => expect(a.init(2, 4, 8, 16).invert()).toBe(a) )
  })
  describe("#invertOut", () => {
    it ("inverts", () => expectComponents(new Glib.Vec4(2, 4, 8, 16).invertOut(a), 0.5, 0.25, 0.125, 0.0625) )
    it ("return instance", () => expect(a.init(2, 4, 8, 16).invertOut(b)).toBe(b) )
  })
  describe("#negate", () => {
    it ("negates", () => expectComponents(new Glib.Vec4(2, 4, 8, 16).negate(), -2, -4, -8, -16) )
    it ("return instance", () => expect(a.init(2, 4, 8, 16).negate()).toBe(a) )
  })
  describe("#negateOut", () => {
    it ("negates", () => expectComponents(new Glib.Vec4(2, 4, 8, 16).negateOut(a), -2, -4, -8, -16) )
  ...
  describe("add operations", () => {
    beforeEach(() => {
      a = new Glib.Vec4(1, 2, 3, 4)
      b = new Glib.Vec4(5, 6, 7, 8)
      c = new Glib.Vec4(6, 8, 10, 12)
    })
    describe("#add", () => {
    ...
    describe(".add", () => {
      ...
      it ("returns given instance", () => expect(Glib.Vec4.add(a, b, d)).toBe(d))
    })
  })

  describe("operation", () => {
    beforeEach(() => {
      a = new Glib.Vec4(5, 6, 7, 8)
      b = new Glib.Vec4(4, 3, 2, 1)
      c = new Glib.Vec4(1, 3, 5, 7)
    })
    describe("#subtract", () => {
    ...
    describe(".subtract", () => {
      ...
      it ("returns given instance", () => expect(Glib.Vec4.subtract(a, b, d)).toBe(d))
    })
  })
  ...
  describe("operation", () => {
    ...
    describe(".multiply", () => {
      ...
      it ("returns given instance", () => expect(Glib.Vec4.multiply(a, b, d)).toBe(d))
    })
  })

  describe("operation", () => {
    beforeEach(() => {
      a = new Glib.Vec4(4, 16, 64, 256)
      b = new Glib.Vec4(2, 4, 8, 16)
      c = new Glib.Vec4(2, 4, 8, 16)
    })
    describe("#divide", () => {
    ...
    describe(".divide", () => {
      ...
      it ("returns given instance", () => expect(Glib.Vec4.divide(a, b, d)).toBe(d))
    })
  })
})
