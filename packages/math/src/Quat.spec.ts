...
describe('Quat', () => {
  ...
  describe('.transform', () => {
    it('transforms an IVec3', () => {
      expectV3Components(Quat.transform(Quat.createAxisAngle(Vec3.UnitX, 0.5 * Math.PI), Vec3.create(1, 0, 0)), 1, 0, 0)
      expectV3Components(Quat.transform(Quat.createAxisAngle(Vec3.UnitX, 0.5 * Math.PI), Vec3.create(0, 1, 0)), 0, 0, 1)
      expectV3Components(
        Quat.transform(Quat.createAxisAngle(Vec3.UnitX, 0.5 * Math.PI), Vec3.create(0, 0, 1)),
        0,
        -1,
        0,
      )
      ...
      expectV3Components(
        Quat.transform(Quat.createAxisAngle(Vec3.UnitY, 0.5 * Math.PI), Vec3.create(1, 0, 0)),
        0,
        0,
        -1,
      )
      expectV3Components(Quat.transform(Quat.createAxisAngle(Vec3.UnitY, 0.5 * Math.PI), Vec3.create(0, 1, 0)), 0, 1, 0)
      expectV3Components(Quat.transform(Quat.createAxisAngle(Vec3.UnitY, 0.5 * Math.PI), Vec3.create(0, 0, 1)), 1, 0, 0)

      expectV3Components(Quat.transform(Quat.createAxisAngle(Vec3.UnitZ, 0.5 * Math.PI), Vec3.create(1, 0, 0)), 0, 1, 0)
      expectV3Components(
        Quat.transform(Quat.createAxisAngle(Vec3.UnitZ, 0.5 * Math.PI), Vec3.create(0, 1, 0)),
        -1,
        0,
        0,
      )
      expectV3Components(Quat.transform(Quat.createAxisAngle(Vec3.UnitZ, 0.5 * Math.PI), Vec3.create(0, 0, 1)), 0, 0, 1)
    })
  })

  describe('#transform', () => {
    it('transforms an IVec3', () => {
      expectV3Components(Quat.createAxisAngle(Vec3.UnitX, 0.5 * Math.PI).transform(Vec3.create(1, 0, 0)), 1, 0, 0)
      expectV3Components(Quat.createAxisAngle(Vec3.UnitX, 0.5 * Math.PI).transform(Vec3.create(0, 1, 0)), 0, 0, 1)
      expectV3Components(Quat.createAxisAngle(Vec3.UnitX, 0.5 * Math.PI).transform(Vec3.create(0, 0, 1)), 0, -1, 0)

      expectV3Components(Quat.createAxisAngle(Vec3.UnitY, 0.5 * Math.PI).transform(Vec3.create(1, 0, 0)), 0, 0, -1)
      expectV3Components(Quat.createAxisAngle(Vec3.UnitY, 0.5 * Math.PI).transform(Vec3.create(0, 1, 0)), 0, 1, 0)
      expectV3Components(Quat.createAxisAngle(Vec3.UnitY, 0.5 * Math.PI).transform(Vec3.create(0, 0, 1)), 1, 0, 0)

      expectV3Components(Quat.createAxisAngle(Vec3.UnitZ, 0.5 * Math.PI).transform(Vec3.create(1, 0, 0)), 0, 1, 0)
      expectV3Components(Quat.createAxisAngle(Vec3.UnitZ, 0.5 * Math.PI).transform(Vec3.create(0, 1, 0)), -1, 0, 0)
      expectV3Components(Quat.createAxisAngle(Vec3.UnitZ, 0.5 * Math.PI).transform(Vec3.create(0, 0, 1)), 0, 0, 1)
    })
  })
  ...
  describe('#initYawPitchRoll', () => {
    it('initializes the quaternion', () => {
      expectEquality(
        new Quat().initYawPitchRoll(Math.PI * 0.5, 0, 0),
        Quat.createAxisAngle({ x: 0, y: 1, z: 0 }, Math.PI * 0.5),
      )
      expectEquality(
        new Quat().initYawPitchRoll(0, Math.PI * 0.5, 0),
        Quat.createAxisAngle({ x: 1, y: 0, z: 0 }, Math.PI * 0.5),
      )
      expectEquality(
        new Quat().initYawPitchRoll(0, 0, Math.PI * 0.5),
        Quat.createAxisAngle({ x: 0, y: 0, z: 1 }, Math.PI * 0.5),
      )
    })
  })
  ...
  describe('.createYawPitchRoll', () => {
    it('initializes the quaternion', () => {
      expectEquality(
        Quat.createYawPitchRoll(Math.PI * 0.5, 0, 0),
        Quat.createAxisAngle({ x: 0, y: 1, z: 0 }, Math.PI * 0.5),
      )
      expectEquality(
        Quat.createYawPitchRoll(0, Math.PI * 0.5, 0),
        Quat.createAxisAngle({ x: 1, y: 0, z: 0 }, Math.PI * 0.5),
      )
      expectEquality(
        Quat.createYawPitchRoll(0, 0, Math.PI * 0.5),
        Quat.createAxisAngle({ x: 0, y: 0, z: 1 }, Math.PI * 0.5),
      )
    })
  })
