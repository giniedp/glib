...
describe('Vec3', () => {
  function expectComponents(v: IVec3, x: number, y: number, z: number) {
    expect(v.x, 'x component of Vec3 invalid').toBeCloseTo(x, 10)
    expect(v.y, 'y component of Vec3 invalid').toBeCloseTo(y, 10)
    expect(v.z, 'z component of Vec3 invalid').toBeCloseTo(z, 10)
  }

  function expectEquality(v1: IVec3, v2: IVec3) {
    expect(v1.x, 'x component of Vec3 invalid').toBeCloseTo(v2.x, 10)
    expect(v1.y, 'y component of Vec3 invalid').toBeCloseTo(v2.y, 10)
    expect(v1.z, 'z component of Vec3 invalid').toBeCloseTo(v2.z, 10)
  }
  ...
  describe('.clone', () => {
    ...
    it('clones all components', () => expectComponents(Vec3.copy(a), 1, 2, 3))
    it('returns new instance', () => expect(Vec3.copy(a)).not.toBe(a))
  })
  describe('#toArray', () => {
    beforeEach(() => {
      a = new Vec3(1, 2, 3)
  ...
  describe('#transformByQuat', () => {
    it('transforms by quaternion', () => {
      expectComponents(
        Vec3.create(1, 1, 1).transformByQuat(Quat.createAxisAngle({ x: 1, y: 0, z: 0 }, Math.PI * 0.5)),
        1,
        -1,
        1,
      )
      expectComponents(
        Vec3.create(1, 1, 1).transformByQuat(Quat.createAxisAngle({ x: 0, y: 1, z: 0 }, Math.PI * 0.5)),
        1,
        1,
        -1,
      )
      expectComponents(
        Vec3.create(1, 1, 1).transformByQuat(Quat.createAxisAngle({ x: 0, y: 0, z: 1 }, Math.PI * 0.5)),
        -1,
        1,
        1,
      )
  ...
  describe('#transformByMat4', () => {
    it('transforms by Mat4', () => {
      expectComponents(
        Vec3.create(1, 1, 1).transformByMat4(Mat4.createAxisAngle({ x: 1, y: 0, z: 0 }, Math.PI * 0.5)),
        1,
        -1,
        1,
      )
      expectComponents(
        Vec3.create(1, 1, 1).transformByMat4(Mat4.createAxisAngle({ x: 0, y: 1, z: 0 }, Math.PI * 0.5)),
        1,
        1,
        -1,
      )
      expectComponents(
        Vec3.create(1, 1, 1).transformByMat4(Mat4.createAxisAngle({ x: 0, y: 0, z: 1 }, Math.PI * 0.5)),
        -1,
        1,
        1,
      )
  ...
  describe('#transformByMat3', () => {
    it('transforms by Mat3', () => {
      expectComponents(
        Vec3.create(1, 1, 1).transformByMat3(Mat3.createAxisAngle({ x: 1, y: 0, z: 0 }, Math.PI * 0.5)),
        1,
        -1,
        1,
      )
      expectComponents(
        Vec3.create(1, 1, 1).transformByMat3(Mat3.createAxisAngle({ x: 0, y: 1, z: 0 }, Math.PI * 0.5)),
        1,
        1,
        -1,
      )
      expectComponents(
        Vec3.create(1, 1, 1).transformByMat3(Mat3.createAxisAngle({ x: 0, y: 0, z: 1 }, Math.PI * 0.5)),
        -1,
        1,
        1,
      )
