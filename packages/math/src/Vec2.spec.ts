...
describe('Vec2', () => {
  ...
  describe('#initFromBuffer', () => {
    it('inits all components', () => expectComponents(a.initFromArray([1, 2, 3, 4], 1), 2, 3))
    it('returns same instance', () => expect(a.initFromArray([1, 2, 3, 4, 5], 1)).toBe(a))
  })
  describe('.createFromBuffer', () => {
    it('inits all components', () => expectComponents(Vec2.createFromArray([1, 2, 3, 4], 1), 2, 3))
  })
  describe('#clone', () => {
    beforeEach(() => {
      a = new Vec2(1, 2)
    })
    it('clones all components', () => expectComponents(a.copy(), 1, 2))
  ...
  describe('.clone', () => {
    ...
    it('clones all components', () => expectComponents(Vec2.copy(a), 1, 2))
    it('returns new instance', () => expect(Vec2.copy(a)).not.toBe(a))
  })
  describe('#toArray', () => {
    beforeEach(() => {
      a = new Vec2(1, 2)
  ...
  describe('.magnitude', () => {
    it('calculates length', () => {
      expect(Vec2.magnitude(new Vec2(2, 0))).toBe(2)
      expect(Vec2.magnitude(new Vec2(0, 3))).toBe(3)
    })
  })
  ...
  describe('.normalize', () => {
    it('normalizes', () => expect(Vec2.magnitude(Vec2.normalize(new Vec2(1, 2)))).toBeCloseTo(1))
  })
  describe('#invert', () => {
