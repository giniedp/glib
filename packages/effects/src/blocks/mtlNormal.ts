 ...
 */
export const MTL_NORMAL = Object.freeze({
  defines: glsl`
    #ifdef NORMAL_MAP
  ...
  fs_surface: glsl`
    ...
    #ifdef NORMAL_MAP
    #ifdef NORMAL_MAP_OFFSET_SCALE
    surface.Normal.xyz = normalize(vTBN * texture2D(uNormalMap, uEmissionMapOffsetScale.xy + uEmissionMapOffsetScale.zw * NORMAL_MAP_UV).rgb * 2.0 - 1.0);
    #else
