// import type { EffectDocument } from '@gglib/graphics'
...
//           vec4 position = getPosition(vPosition, vVelocity,
//                                                     age, normalizedAge);

//           float size = getSize(vRandom.y, normalizedAge);
//           mat2 rotation = getRotation(vRandom.w, age);

//           position.xy += (vCorner * rotation) * size * uViewportScale;

//           texColor = getColor(position, vRandom.z, normalizedAge);
