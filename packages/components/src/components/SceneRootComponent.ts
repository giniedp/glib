...
export class SceneRootComponent implements GameComponent, InitializableComponent, RenderScene {
  ...
  public initialize(): void {
    ...
    this.qSpatial = this.world.query({ scope: 'active', required: [this.Tag, SpatialRootComponent] })
    this.qMeshes = this.world.query({ scope: 'active', required: [this.Tag, MeshComponent], rejected: [...rejected] })
    this.qModels = this.world.query({ scope: 'active', required: [this.Tag, ModelComponent], rejected: [...rejected] })
    this.qSprites = this.world.query({
      scope: 'active',
      required: [this.Tag, SpriteComponent],
      rejected: [...rejected],
    })
