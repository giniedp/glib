...
export class SpatialNodeComponent implements GameComponent {
  public static readonly onDirty = brand<EventType<SpatialNodeComponent>>(Symbol('SpatialNodeComponent.onDirty'))
  public static readonly onUpdated = brand<EventType<SpatialNodeComponent>>(Symbol('SpatialNodeComponent.onUpdated'))
  ...
  public emitDirtyEvent = () => {
    this.entity.events.emit(SpatialNodeComponent.onDirty, this)
  }
  ...
  public updateFitting() {
    ...
    if (!this.root) {
      console.warn('SpatialNodeComponent has no root, cannot update fitting')
      return
    }
    ...
    this.entity.events.emit(SpatialNodeComponent.onUpdated, this)
  }
}
