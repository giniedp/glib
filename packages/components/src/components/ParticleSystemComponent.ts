...
import { BlendStateParams, Color, Device, Texture } from '@gglib/graphics'
...
export class ParticleSystemComponent implements GameSystem {
  ...
  public initialize(container: GameProvider): void {
    this.device = container.get(Device)
