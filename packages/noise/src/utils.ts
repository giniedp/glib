...
export type NeighboringType = number
export const NeighboringType = {
  /**
...
export function Spline(value: number, ...knots: number[]): number {
  ...
  const c3 = CR00 * knots[span + 0] + CR01 * knots[span + 1] + CR02 * knots[span + 2] + CR03 * knots[span + 3]
  const c2 = CR10 * knots[span + 0] + CR11 * knots[span + 1] + CR12 * knots[span + 2] + CR13 * knots[span + 3]
  const c1 = CR20 * knots[span + 0] + CR21 * knots[span + 1] + CR22 * knots[span + 2] + CR23 * knots[span + 3]
  const c0 = CR30 * knots[span + 0] + CR31 * knots[span + 1] + CR32 * knots[span + 2] + CR33 * knots[span + 3]
