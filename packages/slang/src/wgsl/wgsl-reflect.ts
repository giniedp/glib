import type { ScalarType, ShaderInputType } from '../common'
...
function resourceInfo(
  container: ShaderInputType | 'scalar',
  type: ScalarType,
  elements: number,
  align: number,
  size: number,
