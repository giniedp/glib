import type { ScalarType } from '../common'
...
function scalar(elementType: ScalarType): GlslTypeScalar {
  return {
    container: 'scalar',
    componentCount: 1,
...
function vector(elementType: ScalarType, elementCount: 2 | 3 | 4): GlslTypeVector {
  return {
...
function matrix(elementType: ScalarType, a: 2 | 3 | 4, b: 2 | 3 | 4): GlslTypeMatrix {
  return {
    container: `mat${a}x${b}`,
    componentType: elementType,
    componentCount: a * b,
