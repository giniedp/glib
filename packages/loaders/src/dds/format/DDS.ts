import { SurfaceFormat } from '@gglib/graphics'
...
export function parse(buffer: ArrayBuffer) {
  ...
  return {
    ...
    depth: header.Depth,
    format,
    isCompressed: isDXGICompressedFormat(format),
    isCubemap,
    webglExtension: getRequiredWebGLExtension(format),
    images,
  }
}
...
export function isDXGICompressedFormat(format: DXGI_FORMAT): boolean {
  switch (format) {
    case DXGI_FORMAT.DXGI_FORMAT_BC1_TYPELESS:
    case DXGI_FORMAT.DXGI_FORMAT_BC1_UNORM:
    case DXGI_FORMAT.DXGI_FORMAT_BC1_UNORM_SRGB:
...
export function getRequiredWebGLExtension(format: DXGI_FORMAT): string | null {
  switch (format) {
    // --- BC1, BC2, BC3 ---
    case DXGI_FORMAT.DXGI_FORMAT_BC1_TYPELESS:
    case DXGI_FORMAT.DXGI_FORMAT_BC1_UNORM:
...
export function getSurfaceFormatFromDXGI(format: DXGI_FORMAT): SurfaceFormat {
  switch (format) {
    ...
    case DXGI_FORMAT.DXGI_FORMAT_R8G8B8A8_UNORM_SRGB:
      return SurfaceFormat.SRGB8_ALPHA8
    case DXGI_FORMAT.DXGI_FORMAT_R8G8B8A8_SNORM:
      return SurfaceFormat.RGBA8_SNORM
    case DXGI_FORMAT.DXGI_FORMAT_R8G8B8A8_UINT:
      return SurfaceFormat.RGBA8UI
    case DXGI_FORMAT.DXGI_FORMAT_R8G8B8A8_SINT:
      return SurfaceFormat.RGBA8I

    // 16-bit/channel RGBA
    case DXGI_FORMAT.DXGI_FORMAT_R16G16B16A16_FLOAT:
      return SurfaceFormat.RGBA16F
    case DXGI_FORMAT.DXGI_FORMAT_R16G16B16A16_UNORM:
      return SurfaceFormat.RGBA16_EXT
    case DXGI_FORMAT.DXGI_FORMAT_R16G16B16A16_SNORM:
      return SurfaceFormat.RGBA16_SNORM_EXT
    case DXGI_FORMAT.DXGI_FORMAT_R16G16B16A16_UINT:
      return SurfaceFormat.RGBA16UI
    case DXGI_FORMAT.DXGI_FORMAT_R16G16B16A16_SINT:
      return SurfaceFormat.RGBA16I

    // 10-bit packed RGBA
    case DXGI_FORMAT.DXGI_FORMAT_R10G10B10A2_UNORM:
      return SurfaceFormat.RGB10_A2
    case DXGI_FORMAT.DXGI_FORMAT_R10G10B10A2_UINT:
      return SurfaceFormat.RGB10_A2UI

    // 11/10-bit packed float
    case DXGI_FORMAT.DXGI_FORMAT_R11G11B10_FLOAT:
      return SurfaceFormat.R11F_G11F_B10F

    // 16-bit/channel RG
    case DXGI_FORMAT.DXGI_FORMAT_R16G16_FLOAT:
      return SurfaceFormat.RG16F
    case DXGI_FORMAT.DXGI_FORMAT_R16G16_UNORM:
      return SurfaceFormat.RG16_EXT
    case DXGI_FORMAT.DXGI_FORMAT_R16G16_SNORM:
      return SurfaceFormat.RG16_SNORM_EXT

    // 8-bit/channel RG
    case DXGI_FORMAT.DXGI_FORMAT_R8G8_UNORM:
      return SurfaceFormat.RG8
    case DXGI_FORMAT.DXGI_FORMAT_R8G8_SNORM:
      return SurfaceFormat.RG8_SNORM

    // 16-bit float R
    case DXGI_FORMAT.DXGI_FORMAT_R16_FLOAT:
      return SurfaceFormat.R16F
    case DXGI_FORMAT.DXGI_FORMAT_R16_UNORM:
      return SurfaceFormat.R16_EXT
    case DXGI_FORMAT.DXGI_FORMAT_R16_SNORM:
      return SurfaceFormat.R16_SNORM_EXT

    // 8-bit R
    case DXGI_FORMAT.DXGI_FORMAT_R8_UNORM:
      return SurfaceFormat.R8
    case DXGI_FORMAT.DXGI_FORMAT_R8_SNORM:
      return SurfaceFormat.R8_SNORM

    // 32-bit float RGB(A)
    case DXGI_FORMAT.DXGI_FORMAT_R32_FLOAT:
      return SurfaceFormat.R32F
    case DXGI_FORMAT.DXGI_FORMAT_R32G32_FLOAT:
      return SurfaceFormat.RG32F
    case DXGI_FORMAT.DXGI_FORMAT_R32G32B32_FLOAT:
      return SurfaceFormat.RGB32F
    case DXGI_FORMAT.DXGI_FORMAT_R32G32B32A32_FLOAT:
      return SurfaceFormat.RGBA32F
    ...
    case DXGI_FORMAT.DXGI_FORMAT_BC1_UNORM:
    case DXGI_FORMAT.DXGI_FORMAT_BC1_TYPELESS:
      return SurfaceFormat.COMPRESSED_RGBA_S3TC_DXT1_EXT
    case DXGI_FORMAT.DXGI_FORMAT_BC1_UNORM_SRGB:
      return SurfaceFormat.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT

    // BC2
    case DXGI_FORMAT.DXGI_FORMAT_BC2_UNORM:
    case DXGI_FORMAT.DXGI_FORMAT_BC2_TYPELESS:
      return SurfaceFormat.COMPRESSED_RGBA_S3TC_DXT3_EXT
    case DXGI_FORMAT.DXGI_FORMAT_BC2_UNORM_SRGB:
      return SurfaceFormat.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT

    // BC3
    case DXGI_FORMAT.DXGI_FORMAT_BC3_UNORM:
    case DXGI_FORMAT.DXGI_FORMAT_BC3_TYPELESS:
      return SurfaceFormat.COMPRESSED_RGBA_S3TC_DXT5_EXT
    case DXGI_FORMAT.DXGI_FORMAT_BC3_UNORM_SRGB:
      return SurfaceFormat.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT

    // BC4
    case DXGI_FORMAT.DXGI_FORMAT_BC4_UNORM:
      return SurfaceFormat.COMPRESSED_RED_RGTC1_EXT
    case DXGI_FORMAT.DXGI_FORMAT_BC4_SNORM:
      return SurfaceFormat.COMPRESSED_SIGNED_RED_RGTC1_EXT

    // BC5
    case DXGI_FORMAT.DXGI_FORMAT_BC5_UNORM:
      return SurfaceFormat.COMPRESSED_RED_GREEN_RGTC2_EXT
    case DXGI_FORMAT.DXGI_FORMAT_BC5_SNORM:
      return SurfaceFormat.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT

    // BC6H
    case DXGI_FORMAT.DXGI_FORMAT_BC6H_UF16:
      return SurfaceFormat.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT
    case DXGI_FORMAT.DXGI_FORMAT_BC6H_SF16:
      return SurfaceFormat.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT

    // BC7
    case DXGI_FORMAT.DXGI_FORMAT_BC7_UNORM:

      return SurfaceFormat.COMPRESSED_RGBA_BPTC_UNORM_EXT
    case DXGI_FORMAT.DXGI_FORMAT_BC7_UNORM_SRGB:
      return SurfaceFormat.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT

    default:
      return null; // Unsupported or unknown
  }
}
