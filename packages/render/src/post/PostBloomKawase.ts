...
//     const resultTarget = ctx.targets.acquire(baseTarget)
//     const renderTarget1 = ctx.targets.acquire(this.targetOptions)
//     const renderTarget2 = ctx.targets.acquire(this.targetOptions)
