...
export interface HttpRequestOptions<R extends HttpResponseType = null> {
  method?: HttpMethod
...
export class HttpClient {
  ...
  public async fetch(url: string, options: HttpRequestOptions<'blob'>): Promise<HttpResponse<Blob>>
  public async fetch(url: string, options: HttpRequestOptions<'arraybuffer'>): Promise<HttpResponse<ArrayBuffer>>
  public async fetch<T = any>(url: string, options: HttpRequestOptions<'json'>): Promise<HttpResponse<T>>
  ...
  protected createRequestInit(options: HttpRequestOptions<any>): RequestInit {
