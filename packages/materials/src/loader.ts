...
// import { Material, MaterialOptions, CullState, BlendState, EffectPassOptions } from '@gglib/graphics'
...
//  * @public
//  */
// export const loadMaterialOptionsToEffectOptions: LoaderSpec<TypeToken<MaterialOptions>, TypeToken<MaterialOptions>> = loader({
