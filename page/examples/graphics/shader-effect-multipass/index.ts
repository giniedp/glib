import { BlendState, buildSphere, CullState, DepthState, DeviceGL, ModelBuilder, createDevice } from '@gglib/graphics'
...
const mesh = ModelBuilder.begin().append(buildSphere).endMeshPart(device)
